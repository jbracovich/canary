...
HomeBanners = {
	images = { "home/banner_babyelephant.png" },
	delay = 10,
}
...
GameStore.Categories = {
	...
	-- Extras ~ Items Draconia
	{
		icons = { "Draptor_Dollbp.png" },
		name = "Draconia Items",
		rookgaard = true,
		subclasses = { "Forge Items", "Stamina", "Items Vip", "Teleport Cube", "Backpacks" },
	},
		...
		offers = {
			{
				...
				itemtype = 37110,
				count = 1,
				description = "<i>This item increases your probability of tier enhancement and prevents item loss.</i>\n\n{info} The quantity of Exalted Cores increases depending on the tier of the item, both for upgrading and for transferring the tier from one item to another.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true
	...
	-- Draconia Items ~ Stamina
	{
		...
		offers = {
			...
			{
				icons = { "Small_Stamina_Refill.png" },
				name = "Small Stamina Refill",
				price = 450,
				itemtype = 36725,
				count = 1,
				description = "<i>Drinking this potion fills stamina and recharges twelve hours.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
			    home = true,
				movable = true
