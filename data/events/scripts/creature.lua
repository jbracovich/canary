...
function Creature.checkCreatureInsideDoor(creature, position)
    if not creature then
        print("checkCreatureInsideDoor: creature is nil")
        return false
    end

    if not position then
        print("checkCreatureInsideDoor: position is nil")
        return false
    end

    local tile = Tile(position)
    if not tile then
        print("checkCreatureInsideDoor: tile is nil at position:", position)
        return false
    end

    local creatures = tile:getCreatures()
    if not creatures then
        print("checkCreatureInsideDoor: no creatures found at position:", position)
        return false
    end

    for _, topCreature in ipairs(creatures) do
        if topCreature == creature then
            return true
        end
    end
