...
local potions = {
    [236] = { health = { 800, 1200 }, vocations = { VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.KNIGHT }, level = 50, description = "Only knights and paladins of level 50 or above may drink this fluid." },
    [237] = { mana = { 300, 500 }, level = 50, description = "Only players of level 50 or above may drink this fluid." },
    [238] = { mana = { 500, 800 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID, VOCATION.BASE_ID.PALADIN }, level = 80, description = "Only sorcerers, druids and paladins of level 80 or above may drink this fluid." },
    [239] = { health = { 1200, 1800 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 80, description = "Only knights of level 80 or above may drink this fluid." },
    [266] = { health = { 400, 600 } },
    [268] = { mana = { 200, 400 } },
    ...
    [7642] = { health = { 800, 1200 }, mana = { 300, 600 }, vocations = { VOCATION.BASE_ID.PALADIN }, level = 80, description = "Only paladins of level 80 or above may drink this fluid." },
    [7643] = { health = { 1800, 2400 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 130, description = "Only knights of level 130 or above may drink this fluid." },
    [7644] = { combat = antidote },
    [7876] = { health = { 200, 300 } },
    [23373] = { mana = { 1200, 1800 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID }, level = 130, description = "Only druids and sorcerers of level 130 or above may drink this fluid." },
    [23374] = { health = { 1200, 1600 }, mana = { 800, 1200 }, vocations = { VOCATION.BASE_ID.PALADIN }, level = 130, description = "Only paladins of level 130 or above may drink this fluid." },
    [23375] = { health = { 2500, 3500 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 200, description = "Only knights of level 200 or above may drink this fluid." },
