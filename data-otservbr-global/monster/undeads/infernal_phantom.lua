...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -650, maxDamage = -1100, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "extended fire chain", interval = 2000, chance = 15, minDamage = -500, maxDamage = -700, range = 7 },
	{ name = "combat", interval = 3000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -650, maxDamage = -1120, radius = 4, effect = CONST_ME_FIREAREA, target = false },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -680, maxDamage = -1050, length = 6, spread = 3, effect = CONST_ME_EXPLOSIONHIT, target = false },
