...
// Por defecto, OTCv8 utiliza CLIENTE_WINDOWS por compatibilidad hacia atrás
// Para el valor correcto, habilita g_game.enableFeature(GameExtendedOpcode)
// en modules/game_features/features.lua
